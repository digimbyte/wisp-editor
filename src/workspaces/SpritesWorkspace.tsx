...
import { InfiniteCanvas, InfiniteFocusButton } from '../components/SpriteEditor';
import type { SpriteAsset } from '../types';

export interface SpritesWorkspaceProps {
  sprites: SpriteAsset[];
...
export const SpritesWorkspace: React.FC<SpritesWorkspaceProps> = ({
  sprites,
  selectedSprite,
  spriteEditorMode,
  setSpriteEditorMode,
      ...
      <div style={{ flex: 1, position: "relative", background: "#1a1d23" }}>
        ...
        <div style={{
          ...
          {[
            ...
            <button
              key={m.mode}
              onClick={() => setSpriteEditorMode(m.mode as any)}
              style={{
                padding: "8px 12px",
        ...
        <div style={{
          ...
          <button
            onClick={() => setCanvasView(canvasView === '2d' ? '3d' : '2d')}
            style={{
              padding: "8px 16px",
              background: "linear-gradient(135deg, #2b6cff, #4d8aff)",
              border: "none",
